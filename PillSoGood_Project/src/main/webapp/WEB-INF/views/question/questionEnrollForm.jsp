        ...
        <div id="content">
            ...
            <div id="content_2">
                ...
                <div id="content_2_2">
                    ...
                    <form action="insert.qu" method="post">
                        <!-- 영섭 작업 영역 시작 -->

                        <!-- 제목 부분 -->
                        <div id="inquiryTitle" class="inquiryClass">
                            <p class="contentText">제목</p>
                            <input type="text" class="form-control" placeholder="&nbsp최대 30자 이내 입력">
                        </div>
                        <br>
                        ...
                        <div id="inquiryContent" class="inquiryClass">
                            ...
                            <textarea name="" id="" cols="30" rows="15" class="form-control" placeholder="&nbsp상담내용 입력" style="resize: none;"></textarea>
                        </div>
                        <br>
